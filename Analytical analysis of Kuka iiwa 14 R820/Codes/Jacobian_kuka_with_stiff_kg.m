function [J,kg] = Jacobian_kuka_with_stiff_kg(th1,th2,th3,th4,th5,th6,th7,F)
...
% defining the elements of the kg matrix
a1 = diff(Jv',theta1)*F;
a2 = diff(Jv',theta2)*F;
a3 = diff(Jv',theta3)*F;
a4 = diff(Jv',theta4)*F;
...
a6 = diff(Jv',theta6)*F;
a7 = diff(Jv',theta7)*F;
kg = [a1,a2,a3,a4,a5,a6,a7];
% replacing the numerical values of thetas in kg matrix
kg = double(subs(kg,{theta1,theta2,theta3,theta4,theta5,theta6,theta7},{th1,th2,th3,th4,th5,th6,th7}));
